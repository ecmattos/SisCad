...
class Member extends Revisionable
{
    ...
    {
        return $this->belongsTo('SisCad\City'); 
    }

    public function member_status()
    {
        return $this->belongsTo('SisCad\MemberStatus');  
    }

    public function plan()
    {
        return $this->belongsTo('SisCad\Plan');   
    }

    public function gender()
    {
        return $this->belongsTo('SisCad\Gender');   
    }

    public function member_status_reason()
    {
        return $this->belongsTo('SisCad\MemberStatusReason');   
    }

    public function bank()
    {
        return $this->belongsTo('SisCad\Bank'); 
    }
