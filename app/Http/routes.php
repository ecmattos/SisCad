...
Route::get('/', ['as' => 'dashboard.pc_members', 'uses' => 'DashboardController@pc_members']);
...
Route::get('/affiliated_societies/', ['as' => 'affiliated_societies', 'uses' => 'AffiliatedSocietiesController@index']);
Route::get('/affiliated_societies/create', ['as' => 'affiliated_societies.create', 'uses' => 'AffiliatedSocietiesController@create', 'middleware' => ['acl:affiliated_societies.create']]);
Route::get('/affiliated_societies/{id}/show', ['as' => 'affiliated_societies.show', 'uses' => 'AffiliatedSocietiesController@show', 'middleware' => ['acl:affiliated_societies.show']]);
Route::get('/affiliated_societies/{id}/edit', ['as' => 'affiliated_societies.edit', 'uses' => 'AffiliatedSocietiesController@edit', 'middleware' => ['acl:affiliated_societies.edit']]);
Route::get('/affiliated_societies/{id}/destroy', ['as' => 'affiliated_societies.destroy', 'uses' => 'AffiliatedSocietiesController@destroy', 'middleware' => ['acl:affiliated_societies.destroy']]);
Route::put('/affiliated_societies/{id}/update', ['as' => 'affiliated_societies.update', 'uses' => 'AffiliatedSocietiesController@update']);
Route::post('/affiliated_societies', ['as' => 'affiliated_societies.store', 'uses' => 'AffiliatedSocietiesController@store']);
