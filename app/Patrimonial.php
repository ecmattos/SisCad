...
class Patrimonial extends Revisionable
{
    ...
    {
        return $this->belongsTo('SisCad\PatrimonialType'); 
    }

    public function patrimonial_sub_type()
    {
        return $this->belongsTo('SisCad\PatrimonialSubType'); 
    }

    public function patrimonial_brand()
    {
        return $this->belongsTo('SisCad\PatrimonialBrand'); 
    }

    public function patrimonial_model()
    {
        return $this->belongsTo('SisCad\PatrimonialModel'); 
    }

    public function patrimonial_status()
    {
        return $this->belongsTo('SisCad\PatrimonialStatus'); 
    }

    public function provider()
    {
        return $this->belongsTo('SisCad\Provider'); 
    }
    ...
    {
        return $this->belongsTo('SisCad\PatrimonialSector'); 
    }

    public function patrimonial_sub_sector()
    {
        return $this->belongsTo('SisCad\PatrimonialSubSector'); 
    }

    public function patrimonial_movements()
    {
        return $this->hasMany('SisCad\PatrimonialMovement'); 
    }
}