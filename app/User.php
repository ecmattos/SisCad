...
class User extends Revisionable implements AuthenticatableContract, CanResetPasswordContract
{
    ...
    */
    ...
    {
        return $this->belongsToMany('SisCad\Role', 'role_user', 'user_id', 'role_id');
    }
}
