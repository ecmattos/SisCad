			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				@if(!Auth::guest())
					<ul class="nav navbar-nav">
						<li><a href="{{ url('/affiliated_societies/') }}">Filiais</a></li>
					</ul>
					<ul class="nav navbar-nav">
						<li><a href="{{ url('/providers/') }}">Fornecedores</a></li>
					</ul>
					<ul class="nav navbar-nav">
						<li><a href="{{ url('/patrimonials/') }}">Ativos</a></li>
					</ul>
					<ul class="nav navbar-nav">
								...
								<ul class="dropdown-menu dropdown-menu-large row">
									<li class="col-sm-3">
										<ul>
											...
											<li><a href="{{ url('/payments/upload/') }}">Importação</a></li>
											<li><a href="{{ url('/payments/search/') }}">Pesquisa</a></li>
										</ul>
										<ul>
						...
						<li class="dropdown dropdown-large">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">Administração <b class="caret"></b></a>
								<ul class="dropdown-menu dropdown-menu-large row">
									<li class="col-sm-4">
										<ul>
											<li class="dropdown-header">Associados</li>
											<li><a href="{{ url('/member_statuses/') }}">Situações</a></li>
											<li><a href="{{ url('/plans/') }}">Planos</a></li>
										</ul>
										<ul>
											<li class="dropdown-header">Pagamentos</li>
											<li><a href="{{ url('/payment_statuses/') }}">Situações</a></li>
											<li><a href="{{ url('/payment_reasons/') }}">Finalidades</a></li>
											<li><a href="{{ url('/payment_methods/') }}">Metodos</a></li>
										</ul>
									</li>

									<li class="col-sm-4">
										<ul>
											<li class="dropdown-header">Parceiros</li>
											<li><a href="{{ url('/partner_types/') }}">Tipos</a></li>
										</ul>
									...
									<li class="col-sm-4">
										<ul>
											...
											<li><a href="{{ url('/patrimonial_movement_types/') }}">Movimentações</a></li>
										</ul>
									</li>
								</ul>
						</li>
			      	...
			      	<form class="form-horizontal" role="form" method="POST" action="{{ url('/auth/login') }}">
				      	<div class="modal-content">
				        	<div class="modal-header">
				          		...
				          		<h4 class="modal-title">SisCad: Informe suas credênciais</h4>
				        	</div>
			    	...
			    	<!-- Modal content-->
			      	<div class="modal-content">
			        	<form class="form-horizontal" role="form" method="POST" action="{{ url('/auth/register') }}">
				        	<div class="modal-header">
				          		<button type="button" class="close" data-dismiss="modal">&times;</button>
				          		<h4 class="modal-title">SisCad: Registre-se aqui</h4>
				        	</div>
				        	<div class="modal-body">
			          			<input type="hidden" name="_token" value="{{ csrf_token() }}">
								<div class="form-group">
			    	...
			    	<!-- Modal content-->
			      	<div class="modal-content">
			        	<form class="form-horizontal" role="form" method="POST" action="{{ url('/password/email') }}">
				        	<div class="modal-header">
				          		<button type="button" class="close" data-dismiss="modal">&times;</button>
				          		<h4 class="modal-title">SisCad: Informe seu e-mail</h4>
				        	</div>
				        	<div class="modal-body">
			          			Informe seu e-mail abaixo para encaminharmos instruções de seu novo acesso.
			          			<br>
			          			<br>
			          			<input type="hidden" name="_token" value="{{ csrf_token() }}">
								<div class="form-group">
