...
<div class="form-group {{ $errors->has('affiliated_society_id') ? 'has-error' : '' }}">
	<label for="affiliated_society_id" class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">Filial:</label>
	<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
		<div class="input-group input-group-sm">
			<span class="input-group-addon"><i class="fa fa-question-circle"></i></span>
			{!! Form::select('affiliated_society_id', $affiliated_societies, $value = null, ['id'=>'affiliated_societies_list', 'class'=>'form-control']) !!}
		</div>
	</div>
</div>
